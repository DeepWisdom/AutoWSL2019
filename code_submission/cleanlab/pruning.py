...
def get_noise_indices(
    ...
    # nr = confident_joint / confident_joint.sum(axis=0)
    # if nr[1, 0] + nr[0, 1] > 0.97:
    #     print(confident_joint)
    #     num_to_remove_per_class = [confident_joint[1, 0]-15, confident_joint[0, 1]-12]
    # else:
    #     num_to_remove_per_class = [confident_joint[1, 0], confident_joint[0, 1]]
    num_to_remove_per_class = [confident_joint[1, 0], confident_joint[0, 1]]
    # frac_noise = 1
